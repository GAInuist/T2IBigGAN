...
from .GlobalAttention import GlobalAttentionGeneral as Global_Attn
...
class Generator(nn.Module):
    def __init__(self,
        ...
        # self.word_attn2 = Global_Attn(ngf * 16, 256)
        ...
        self.word_attn = Global_Attn(ngf, 256)
        # self.block13_1 = GBlock(ngf, ngf,
        #                       upsample=True,
        #                       embedding_size=self.condition_dim + self.z_dim,
        #                       activation=self.activation,
        #                       weight_norm_fn=self.weight_norm_fn,
        ...
        # self.main2 = nn.ModuleList(modules2)

    def forward(self, z, sent_emb, word):
