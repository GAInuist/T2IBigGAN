...
tf.compat.v1.app.flags.DEFINE_string('image_folder',
							'/home/wangxiaopeng/Research/T2I-BigGAN_new/code/netmodel_attn2058/G_net_400/valid',
							"""Path where to load the images """)

tf.compat.v1.app.flags.DEFINE_integer('num_classes', 50,      # 20 for flowers
                            """Number of classes """)
tf.compat.v1.app.flags.DEFINE_integer('splits', 10,
                            """Number of splits """)
tf.compat.v1.app.flags.DEFINE_integer('batch_size', 64, "batch size")
tf.compat.v1.app.flags.DEFINE_integer('gpu', 0, "The ID of GPU to use")
