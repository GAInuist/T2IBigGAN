...
def prepare_data(data):
    imgs, image, captions, captions_lens, class_ids, keys = data
    ...
    return [real_imgs, image, captions, sorted_cap_lens,
            class_ids, keys]

def transform_s(image):
...
class TextDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        imgs, image = get_imgs(img_name, self.imsize,
        ...
        return imgs, image, caps, cap_len, cls_id, key
